...
namespace Napoleon
{
    ...
    namespace MoveGenerator
    {
        ...
        void GetPawnMoves(BitBoard pawns, Board& board, Move moveList[], int& pos);
        void GetKingMoves(BitBoard king, Board& board, Move moveList[], int& pos);
        void GetKnightMoves(BitBoard knights, Board& board, Move moveList[], int& pos);
        void GetRookMoves(BitBoard rooks, Board& board, Move moveList[], int& pos);
        void GetBishopMoves(BitBoard bishops, Board& board, Move moveList[],int& pos);
        void GetQueenMoves(BitBoard queens, Board& board, Move moveList[], int& pos);
    ...
    INLINE void MoveGenerator::GetPawnMoves(BitBoard pawns, Board& board, Move moveList[], int& pos)
    {
        BitBoard targets;
        BitBoard epTargets;
        Byte fromIndex;
            ...
            while (targets != 0)
            {
                ...
                if (board.EnPassantSquare != Constants::Squares::Invalid)
                {
                    ...
                    if ((epTargets & Constants::Masks::SquareMask[board.EnPassantSquare]) != 0)
                        moveList[pos++] =  Move(fromIndex, toIndex, PieceType::Pawn, PieceType::Pawn, PieceType::Pawn);
                }
    ...
    INLINE void MoveGenerator::GetKnightMoves(BitBoard knights, Board &board, Move moveList[], int& pos)
    {
        BitBoard targets;
        Byte fromIndex;
        Byte toIndex;
    ...
    INLINE void MoveGenerator::GetBishopMoves(BitBoard bishops, Board &board, Move moveList[], int& pos)
    {
        BitBoard targets;
        Byte fromIndex;
        Byte toIndex;
    ...
    INLINE void MoveGenerator::GetKingMoves(BitBoard king, Board &board, Move moveList[], int &pos)
    {
        BitBoard targets;
        Byte fromIndex;
        Byte toIndex;
    ...
    INLINE void MoveGenerator::GetRookMoves(BitBoard rooks, Board &board, Move moveList[], int &pos)
    {
        BitBoard targets;
        Byte fromIndex;
        Byte toIndex;
